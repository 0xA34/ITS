...
are statistically reliable and comparable.
...
Components:
    ...
    - BenchmarkComparator: Compare results with your previous benchmarks
...
Usage:
    ...
    # Compare with your previous benchmarks
    comparator = BenchmarkComparator()
    comparison = comparator.compare_with_history(results, model_name="yolov8n")
